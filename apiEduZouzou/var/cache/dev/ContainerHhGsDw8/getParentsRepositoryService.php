 ...
 */
class getParentsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ParentsRepository' shared autowired service.
     *
     * @return \App\Repository\ParentsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ParentsRepository.php';

        return $container->privates['App\\Repository\\ParentsRepository'] = new \App\Repository\ParentsRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
