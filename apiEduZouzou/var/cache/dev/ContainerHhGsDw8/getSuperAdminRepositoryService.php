 ...
 */
class getSuperAdminRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SuperAdminRepository.php';

        return $container->privates['App\\Repository\\SuperAdminRepository'] = new \App\Repository\SuperAdminRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
