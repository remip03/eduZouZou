 ...
 */
final class Version20240726115538 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE classe (id INT AUTO_INCREMENT NOT NULL, ecole_id INT NOT NULL, name_cl VARCHAR(50) DEFAULT NULL, niveau_cl VARCHAR(50) NOT NULL, annee_cl VARCHAR(50) NOT NULL, INDEX IDX_8F87BF9677EF1B1E (ecole_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE enfant (id INT AUTO_INCREMENT NOT NULL, classe_id INT DEFAULT NULL, first_name_e VARCHAR(255) NOT NULL, last_name_e VARCHAR(50) NOT NULL, birth_date_e DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_34B70CA28F5EA509 (classe_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, messagerie_id INT NOT NULL, ecole_id INT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, first_name VARCHAR(50) NOT NULL, last_name VARCHAR(50) NOT NULL, tel VARCHAR(20) NOT NULL, adresse VARCHAR(100) NOT NULL, INDEX IDX_8D93D649836C1031 (messagerie_id), INDEX IDX_8D93D64977EF1B1E (ecole_id), UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
