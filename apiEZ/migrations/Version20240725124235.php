 ...
 */
final class Version20240725124235 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ressource ADD type_act VARCHAR(50) DEFAULT NULL, ADD doc_c VARCHAR(50) DEFAULT NULL, ADD video_c VARCHAR(100) DEFAULT NULL, ADD ressource_sup_c VARCHAR(50) DEFAULT NULL, CHANGE discr dtype VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ressource DROP type_act, DROP doc_c, DROP video_c, DROP ressource_sup_c, CHANGE dtype discr VARCHAR(255) NOT NULL');
    }
}
